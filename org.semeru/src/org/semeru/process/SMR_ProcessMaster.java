...
public class SMR_ProcessMaster extends SvrProcess{
	...
	private String createBrand(int AD_Client_ID,int AD_Org_ID,SMR_Model_Brand data){
		...
		try {
			...
			if(isValid || data.M_Brand_ID > 0 ){
				...
				System.out.println(data.M_Brand_ID);
...
//	
//			
//			setup.setIsActive(data.IsActive);
