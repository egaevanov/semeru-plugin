...
/** Generated Model for SM_STLine
 *  @author iDempiere (generated) 
 *  @version Release 6.2 - $Id$ */
public class X_SM_STLine extends PO implements I_SM_STLine, I_Persistent 
{
    ...
    public X_SM_STLine (Properties ctx, int SM_STLine_ID, String trxName)
    {
      super (ctx, SM_STLine_ID, trxName);
      /** if (SM_STLine_ID == 0)
        {
			setC_Period_ID (0);
    ...
    /** Load Constructor */
    public X_SM_STLine (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_SM_STLine[")
