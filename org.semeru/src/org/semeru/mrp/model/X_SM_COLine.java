...
/** Generated Model for SM_COLine
 *  @author iDempiere (generated) 
 *  @version Release 6.2 - $Id$ */
public class X_SM_COLine extends PO implements I_SM_COLine, I_Persistent 
{
    ...
    public X_SM_COLine (Properties ctx, int SM_COLine_ID, String trxName)
    {
      super (ctx, SM_COLine_ID, trxName);
      /** if (SM_COLine_ID == 0)
        {
			setC_BPartner_ID (0);
			setC_Order_ID (0);
    ...
    /** Load Constructor */
    public X_SM_COLine (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_SM_COLine[")
