...
// N
	...
	/** Set IsCompleteMultiLocator.
		@param IsCompleteMultiLocator IsCompleteMultiLocator	  */
	public void setIsCompleteMultiLocator (boolean IsCompleteMultiLocator)
	{
		set_Value (COLUMNNAME_IsCompleteMultiLocator, Boolean.valueOf(IsCompleteMultiLocator));
	}

	/** Get IsCompleteMultiLocator.
		@return IsCompleteMultiLocator	  */
	public boolean isCompleteMultiLocator () 
	{
		Object oo = get_Value(COLUMNNAME_IsCompleteMultiLocator);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set IsForceLimitPrice.
		@param IsForceLimitPrice IsForceLimitPrice	  */
	public void setIsForceLimitPrice (boolean IsForceLimitPrice)
	{
		set_Value (COLUMNNAME_IsForceLimitPrice, Boolean.valueOf(IsForceLimitPrice));
	}

	/** Get IsForceLimitPrice.
		@return IsForceLimitPrice	  */
	public boolean isForceLimitPrice () 
	{
		Object oo = get_Value(COLUMNNAME_IsForceLimitPrice);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set IsThermalPrint.
		@param IsThermalPrint IsThermalPrint	  */
	public void setIsThermalPrint (boolean IsThermalPrint)
	{
		set_Value (COLUMNNAME_IsThermalPrint, Boolean.valueOf(IsThermalPrint));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_IsThermalPrint);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	{
		set_Value (COLUMNNAME_StoreAddress, StoreAddress);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_StoreAddress);
	}

	/** Set Store Invoice Note.
		@param StoreInvNote Store Invoice Note	  */
	public void setStoreInvNote (String StoreInvNote)
	{
		set_Value (COLUMNNAME_StoreInvNote, StoreInvNote);
	}

	/** Get Store Invoice Note.
		@return Store Invoice Note	  */
	public String getStoreInvNote () 
	{
		return (String)get_Value(COLUMNNAME_StoreInvNote);
	}
	...
	{
		set_Value (COLUMNNAME_StoreName, StoreName);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_StoreName);
	}

	/** Set Store Phone.
		@param StorePhone Store Phone	  */
	public void setStorePhone (String StorePhone)
	{
		set_Value (COLUMNNAME_StorePhone, StorePhone);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_StorePhone);
	}
}