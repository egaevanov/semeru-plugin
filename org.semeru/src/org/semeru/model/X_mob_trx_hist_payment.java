...
/** Generated Model for mob_trx_hist_payment
 *  @author iDempiere (generated) 
 *  @version Release 3.1 - $Id$ */
public class X_mob_trx_hist_payment extends PO implements I_mob_trx_hist_payment, I_Persistent 
{
    ...
    public X_mob_trx_hist_payment (Properties ctx, int mob_trx_hist_payment_ID, String trxName)
    {
      super (ctx, mob_trx_hist_payment_ID, trxName);
      /** if (mob_trx_hist_payment_ID == 0)
        {
			setcontract_no (0);
			setmob_trx_hist_payment_ID (0);
        } */
    }

    /** Load Constructor */
    public X_mob_trx_hist_payment (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_mob_trx_hist_payment[")
	...
	/** Set mob_trx_hist_payment.
		@param mob_trx_hist_payment_ID mob_trx_hist_payment	  */
	public void setmob_trx_hist_payment_ID (int mob_trx_hist_payment_ID)
	{
		if (mob_trx_hist_payment_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_mob_trx_hist_payment_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_mob_trx_hist_payment_ID, Integer.valueOf(mob_trx_hist_payment_ID));
	}

	/** Get mob_trx_hist_payment.
		@return mob_trx_hist_payment	  */
	public int getmob_trx_hist_payment_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_mob_trx_hist_payment_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	/** Set mob_trx_hist_payment_UU.
		@param mob_trx_hist_payment_UU mob_trx_hist_payment_UU	  */
	public void setmob_trx_hist_payment_UU (String mob_trx_hist_payment_UU)
	{
		set_ValueNoCheck (COLUMNNAME_mob_trx_hist_payment_UU, mob_trx_hist_payment_UU);
	}

	/** Get mob_trx_hist_payment_UU.
		@return mob_trx_hist_payment_UU	  */
	public String getmob_trx_hist_payment_UU () 
	{
		return (String)get_Value(COLUMNNAME_mob_trx_hist_payment_UU);
	}
