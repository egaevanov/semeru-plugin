...
public interface I_C_POS 
{
    ...
    /** Column name IsCompleteMultiLocator */
    public static final String COLUMNNAME_IsCompleteMultiLocator = "IsCompleteMultiLocator";
    ...
    /** Column name IsForceLimitPrice */
    public static final String COLUMNNAME_IsForceLimitPrice = "IsForceLimitPrice";
    ...
    /** Column name IsThermalPrint */
    public static final String COLUMNNAME_IsThermalPrint = "IsThermalPrint";
    ...
    public static final String COLUMNNAME_StoreAddress = "StoreAddress";
    ...
    /** Column name StoreInvNote */
    public static final String COLUMNNAME_StoreInvNote = "StoreInvNote";
    ...
    public static final String COLUMNNAME_StoreName = "StoreName";
    ...
    public static final String COLUMNNAME_StorePhone = "StorePhone";
