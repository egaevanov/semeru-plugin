...
/** Generated Interface for SM_SemeruPOS
 *  @author iDempiere (generated) 
 *  @version Release 6.2
 */
@SuppressWarnings("all")
public interface I_SM_SemeruPOS 
{

    /** TableName=SM_SemeruPOS */
    public static final String Table_Name = "SM_SemeruPOS";
    ...
    public static final String COLUMNNAME_IsCashAdvance = "IsCashAdvance";
    ...
    /** Column name PrintDateSJ */
    public static final String COLUMNNAME_PrintDateSJ = "PrintDateSJ";
    ...
    /** Column name PrintSequence */
    public static final String COLUMNNAME_PrintSequence = "PrintSequence";
    ...
    /** Column name PrintSequenceSJ */
    public static final String COLUMNNAME_PrintSequenceSJ = "PrintSequenceSJ";
    ...
    /** Column name SM_SemeruPOS_UU */
    public static final String COLUMNNAME_SM_SemeruPOS_UU = "SM_SemeruPOS_UU";
