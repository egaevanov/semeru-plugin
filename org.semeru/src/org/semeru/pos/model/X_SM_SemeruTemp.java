...
/** Generated Model for SM_SemeruTemp
 *  @author iDempiere (generated) 
 *  @version Release 6.2 - $Id$ */
public class X_SM_SemeruTemp extends PO implements I_SM_SemeruTemp, I_Persistent 
{
    ...
    public X_SM_SemeruTemp (Properties ctx, int SM_SemeruTemp_ID, String trxName)
    {
      super (ctx, SM_SemeruTemp_ID, trxName);
      /** if (SM_SemeruTemp_ID == 0)
        {
			setSM_SemeruTemp_ID (0);
        } */
    }

    /** Load Constructor */
    public X_SM_SemeruTemp (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_SM_SemeruTemp[")
    ...
    {
		return (I_SM_SemeruTemp)MTable.get(getCtx(), I_SM_SemeruTemp.Table_Name)
			.getPO(getSM_SemeruTemp_ID(), get_TrxName());	}

	/** Set SM_SemeruTemp_ID.
		@param SM_SemeruTemp_ID SM_SemeruTemp_ID	  */
	public void setSM_SemeruTemp_ID (int SM_SemeruTemp_ID)
	{
		if (SM_SemeruTemp_ID < 1) 
			set_Value (COLUMNNAME_SM_SemeruTemp_ID, null);
		else 
			set_Value (COLUMNNAME_SM_SemeruTemp_ID, Integer.valueOf(SM_SemeruTemp_ID));
	}

	/** Get SM_SemeruTemp_ID.
		@return SM_SemeruTemp_ID	  */
	public int getSM_SemeruTemp_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_SM_SemeruTemp_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set SM_SemeruTemp_UU.
		@param SM_SemeruTemp_UU SM_SemeruTemp_UU	  */
	public void setSM_SemeruTemp_UU (String SM_SemeruTemp_UU)
	{
		set_ValueNoCheck (COLUMNNAME_SM_SemeruTemp_UU, SM_SemeruTemp_UU);
	}

	/** Get SM_SemeruTemp_UU.
		@return SM_SemeruTemp_UU	  */
	public String getSM_SemeruTemp_UU () 
	{
		return (String)get_Value(COLUMNNAME_SM_SemeruTemp_UU);
	}
